package com.game.blackjack.displayText;
...
public class Text {
    ...
    //MenuVariables
    public static String welcome = "Welcome to Blackjack \n";
    public static String thanks = "Thanks for playing";
    public static String menu = "Enter 1 to Deal\nEnter 2 to for Instructions \nEnter 3 to Exit";
    ...
    public static String initialPlayOptions = "Enter 1 to Hit\nPress 2 to Stay\nEnter 3 to Double Down\nEnter 4 to Split a Pair \nEnter 5 to Purchase Insurance \n";
    ...
    //Methods
    public static String menu(boolean displayWelcome){

        if (displayWelcome){
            return Text.welcome + Text.menu;
        } else {
            return Text.menu;
        }
